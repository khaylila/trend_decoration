...
<head>
    ...
    <title>Login &mdash; Trend Decoration</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="<?= base_url(); ?>img/trendDecorationLogo.png" alt="logo" width="100" class="shadow rounded-circle">
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row sm-gutters">
                                    <div class="col-12">
                                        <a class="btn btn-block bg-danger py-2 text-white" tabindex="4">
                        ...
                        <div class="simple-footer">
                            Copyright &copy; Trend Decoration <?= date('Y'); ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?= base_url(); ?>assets/tooltip/tooltip.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-Fy6S3B9q64WdZWQUiU+q4/2Lc9npb8tCaSX9FK7E8HnRr0Jz8D6OP9dO5Vg3Q9ct" crossorigin="anonymous"></script>
    <!-- <script src="<?= base_url(); ?>assets/bootstrap/js/bootstrap.min.js"></script> -->
    <script src="<?= base_url(); ?>assets/nicescroll/jquery.nicescroll.min.js"></script>
